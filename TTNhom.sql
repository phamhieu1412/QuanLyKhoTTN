...
THEMSANPHAM 'SP001','DÂU GIÓ','600','VIET NAM','CHAI','28000','L006'
THEMSANPHAM 'SP002','TIVI SAMSUNG UA 43 INCH','200','VIET NAM','CHIẾC','8,590,000','L002'
THEMSANPHAM 'SP003','TỦ LẠNH SAMSUNG RTSV','600','VIET NAM','CHIẾC','6.500.000','L002'
THEMSANPHAM 'SP004','TỦ LẠNH SAMSUNG RSSV 560L','600','THÁI LAN','CHAI','29.280.000','L002'
THEMSANPHAM 'SP005','TỦ LẠNH SAMSUNG RBSV 276 L','600','VIET NAM','CHAI','18.000.000','L002'
THEMSANPHAM 'SP006','TIVI SONY KD 55 inch','600','VIET NAM','CHAI','22.000.000','L002'
...
@GHICHU NVARCHAR(200) ,@MANHACUNGCAP VARCHAR(8) ,@SOLUONG INT , @DONGIA DECIMAL(18,2), @TENDANGNHAP VARCHAR(20) )
AS
BEGIN
	INSERT INTO PhieuNhap(MaPN ,NgayNhap ,TongTien ,GhiChu ,MaNCC ,TenDN )
	VALUES (@MAPN ,@NGAYNHAP ,@TONGTIEN ,@GHICHU ,@MANHACUNGCAP ,@TENDANGNHAP )
...
BEGIN
	SELECT PhieuNhap.MaPN, NgayNhap, TongTien, GhiChu, MaNCC, TenDN,  MaSP,
...
@MANHACUNGCAP VARCHAR(8),@TENDANGNHAP VARCHAR(20))
AS
BEGIN
	UPDATE PhieuNhap
	SET NgayNhap = @NGAYNHAP , TongTien = @TONGTIEN , GhiChu=@GHICHU ,MaNCC = @MANHACUNGCAP , TenDN=@TENDANGNHAP
	where MaPN = @MAPN
END
